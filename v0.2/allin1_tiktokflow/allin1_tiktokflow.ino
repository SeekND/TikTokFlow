...
#define NUM_LEDS 15 // number of leds per circle (need to be all the same number for each of the circles you have
...
void setup() {
  ...
  FastLED.addLeds<WS2812, LED_PINA1, GRB>(ledsA1, NUM_LEDS);   // prev brg
  FastLED.addLeds<WS2812, LED_PINA2, GRB>(ledsA2, NUM_LEDS);   // prev brg
  FastLED.addLeds<WS2812, LED_PINA3, GRB>(ledsA3, NUM_LEDS);   // prev brg

  FastLED.addLeds<WS2812, LED_PINB1, GRB>(ledsB1, NUM_LEDS);   // prev brg
  FastLED.addLeds<WS2812, LED_PINB2, GRB>(ledsB2, NUM_LEDS);   // prev brg
  FastLED.addLeds<WS2812, LED_PINB3, GRB>(ledsB3, NUM_LEDS);   // prev brg

  FastLED.addLeds<WS2812, LED_PINC1, GRB>(ledsC1, NUM_LEDS);   // prev brg
  FastLED.addLeds<WS2812, LED_PINC2, GRB>(ledsC2, NUM_LEDS);   // prev brg
  FastLED.addLeds<WS2812, LED_PINC3, GRB>(ledsC3, NUM_LEDS);   // prev brg
